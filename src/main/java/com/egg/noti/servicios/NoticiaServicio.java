...
public class NoticiaServicio {
    ...
    @Transactional
    public void crearNoticia(String titulo, String cuerpo, String foto) throws MiException, IOException {
    ...
    @Transactional(readOnly = true) // propiedad de sólo lectura sin modificacion de base de Datos
    ...
    public void eliminar(Long id) throws MiException{
        Noticia noticia = obtenerNotiPorId(id);
